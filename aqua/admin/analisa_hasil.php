...
<?php
#Cari nilai maximal
$carimax = mysqli_query($conn,"SELECT max(nilai_ipk) as max1,
...
# Cari nilai minimal
$carimin = mysqli_query($conn,"SELECT min(nilai_ipk) as min1,
...
?>
				<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-titl~e">Normalisasi</h6></div>
				<div class="datatable">
					<table class="table table-hover">
						<thead>
							<tr>
