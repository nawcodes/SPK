...
<!-- Body -->
		...
		<!-- Page title -->
			...
			<div class="panel panel-default">
				<div class="panel-heading" align="right"><h6 class="panel-title"><i class="fa fa-bookmark"></i> Data Bobot Kriteria</h6>
				<a href="himpunan_tambah.php"><input type="submit" value="Tambah Bobot" class="btn btn-info"></a>
				</div>
				<div class="datatable">
